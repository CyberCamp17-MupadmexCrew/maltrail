...
var DATATABLES_COLUMNS = { THREAT: 0, SENSOR: 1, EVENTS: 2, SEVERITY: 3, FIRST_SEEN: 4, LAST_SEEN: 5, SPARKLINE: 6, SRC_IP: 7, SRC_PORT: 8, DST_IP: 9, DST_PORT: 10, PROTO: 11, TYPE: 12, TRAIL: 13, INFO: 14, REFERENCE: 15, TAGS: 16, PID: 17, PROCESS_NAME: 18 };
        ...
        complete: function() {
            ...
            PAPAPARSE_COMPLETE_TIMER = setTimeout(function() {
                ...
                for (var threat_text in _THREATS) {
                    ...
                    // Columns added
                    pid = threat_data[4][LOG_COLUMNS.PID];
                    process_name = threat_data[4][LOG_COLUMNS.PROCESS_NAME];
